...
// OpenGL Data
typedef struct ImGui_ImplOpenGL3_Data ImGui_ImplOpenGL3_Data;
...
{
    return igGetCurrentContext() ? (ImGui_ImplOpenGL3_Data*)igGetIO()->BackendRendererUserData : NULL;
}
...
typedef struct ImGui_ImplOpenGL3_VtxAttribState ImGui_ImplOpenGL3_VtxAttribState;
...
bool ImGui_ImplOpenGL3_Init(const char* glsl_version)
{
    ...
    ImGui_ImplOpenGL3_Data *bd = IM_NEW(ImGui_ImplOpenGL3_Data, 1);
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
                ...
                // Bind texture, Draw
                GL_CALL(glBindTexture(GL_TEXTURE_2D, (GLuint)(intptr_t)ImDrawCmd_GetTexID(pcmd)));
#ifdef IMGUI_IMPL_OPENGL_MAY_HAVE_VTX_OFFSET
                if (bd->GlVersion >= 320)
...
static void ImGui_ImplOpenGL3_RenderWindow(ImGuiViewport* viewport, void *_)
{
