...
void leep::GameInit()
{
	...
	// CelticGold
	{
	    ...
	    dw.material_.set_persistent_data((float*)&pbr, sizeof(PbrData) / 4);
	    Texture t[4];
	    ...
	    dw.material_.set_persistent_tex(t, 4);
	}
...
void leep::GameLogic()
{
	...
	usemat->data.usemat.mat = (Material*)THE_AllocateFrameResource(sizeof(Material));
