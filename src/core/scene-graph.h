...
namespace leep
{
    ...
    public:
        ...
        */
        ...
        /*
            When a node is removed, the entity will lose its
            transform hierarchy and the local transform
            will act as a global transform.
        */
        ...
        */
        ...
        /*
            When an entity is removed, the last entity of the container moves its
            components to the free spot in order to fill the gap.
