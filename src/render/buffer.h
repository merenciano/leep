...
namespace leep
{
    ...
    public:
        ...
        void create();
        void create(float* data, int32_t count, BufferType type);
        void create(uint32_t* data, int32_t count);
        void set_data(float *data, int32_t count, BufferType type);
        void set_data(uint32_t *data, int32_t count);
